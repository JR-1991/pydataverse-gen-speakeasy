...
class Wadl:
    ...
    def get_application_wadl(self) -> operations.GetApplicationWadlResponse:
        ...
        res = operations.GetApplicationWadlResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def get_application_wadl_1(self, path: str) -> operations.GetApplicationWadl1Response:
        ...
        res = operations.GetApplicationWadl1Response(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
