...
class Datatags:
    ...
    def post_receive_tags(self, unique_cache_id: str) -> operations.PostReceiveTagsResponse:
        ...
        url = utils.generate_url(base_url, '/api/v1/datatags/receiveTags/{uniqueCacheId}', request)
        ...
        res = operations.PostReceiveTagsResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type') or '', raw_response=http_res)
