...
class Users:
    ...
    def get_user_details(self) -> operations.GetUserDetailsResponse:
        ...
        res = operations.GetUserDetailsResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type') or '', raw_response=http_res)
    ...
    def get_user_token(self) -> operations.GetUserTokenResponse:
        ...
        res = operations.GetUserTokenResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type') or '', raw_response=http_res)
    ...
    def delete_user_token(self) -> operations.DeleteUserTokenResponse:
        ...
        res = operations.DeleteUserTokenResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type') or '', raw_response=http_res)
    ...
    def recreate_user_token(self) -> operations.RecreateUserTokenResponse:
        ...
        res = operations.RecreateUserTokenResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type') or '', raw_response=http_res)
    ...
    def merge_users(self, base_identifier: str, consumed_identifier: str) -> operations.MergeUsersResponse:
        ...
        res = operations.MergeUsersResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type') or '', raw_response=http_res)
    ...
    def change_user_identifier(self, identifier: str, new_identifier: str) -> operations.ChangeUserIdentifierResponse:
        ...
        res = operations.ChangeUserIdentifierResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type') or '', raw_response=http_res)
    ...
    def remove_user_roles(self, identifier: str) -> operations.RemoveUserRolesResponse:
        ...
        res = operations.RemoveUserRolesResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type') or '', raw_response=http_res)
    ...
    def get_user_traces(self, identifier: str) -> operations.GetUserTracesResponse:
        ...
        res = operations.GetUserTracesResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type') or '', raw_response=http_res)
    ...
    def get_user_trace_element(self, element: str, identifier: str) -> operations.GetUserTraceElementResponse:
        ...
        res = operations.GetUserTraceElementResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type') or '', raw_response=http_res)
