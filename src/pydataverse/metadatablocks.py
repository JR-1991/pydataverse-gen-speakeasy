...
class Metadatablocks:
    ...
    def get_metadatablocks(self) -> operations.GetMetadatablocksResponse:
        ...
        res = operations.GetMetadatablocksResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type') or '', raw_response=http_res)
    ...
    def get_metadatablock_1_1(self, identifier: str) -> operations.GetMetadatablock11Response:
        ...
        res = operations.GetMetadatablock11Response(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type') or '', raw_response=http_res)
