...
class Workflows:
    ...
    def start_workflow(self, invocation_id: str) -> operations.StartWorkflowResponse:
        ...
        url = utils.generate_url(base_url, '/api/v1/workflows/{invocationId}', request)
        ...
        res = operations.StartWorkflowResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type') or '', raw_response=http_res)
