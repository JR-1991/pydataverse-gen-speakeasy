...
class Search:
    ...
    def search_query(self, request: operations.SearchQueryRequest) -> operations.SearchQueryResponse:
        ...
        query_params = { **utils.get_query_params(operations.SearchQueryRequest, request), **query_params }
        headers['Accept'] = '*/*'
        ...
        res = operations.SearchQueryResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type') or '', raw_response=http_res)
