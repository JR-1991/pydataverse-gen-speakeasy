...
class DeleteAPIV1AccessDatafileFileIDAuxiliaryFormatTagFormatVersionRequest:
...
@dataclasses.dataclass
class DeleteAPIV1AccessDatafileFileIDAuxiliaryFormatTagFormatVersionResponse:
