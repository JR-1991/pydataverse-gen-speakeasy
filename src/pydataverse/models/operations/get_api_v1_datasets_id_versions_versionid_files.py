...
class GetAPIV1DatasetsIDVersionsVersionIDFilesRequest:
    ...
    order_criteria: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'orderCriteria', 'style': 'form', 'explode': True }})
...
@dataclasses.dataclass
class GetAPIV1DatasetsIDVersionsVersionIDFilesResponse:
